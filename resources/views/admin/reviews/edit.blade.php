...
<div class="admin--container">
    ...
    <div class="login_card-group-wrapper">
        <form enctype="multipart/form-data" action="{{ route('reviews.update',$review->id) }}" method="POST">
            @csrf
            ...
            <div class="login_card-group">
                ...
                <div class="login_card-row">
                    <p style="font-size: 18px;" class="col-form-label">Ссылка (Не обязательно)</p>
                    <input class="input-text" type="url" value="@if(!empty($review->link)) {{ $review->link }} @endif" name="link" class="form-control" placeholder="Ссылка">
                </div>
        
                <div class="login_card-row">
                    <p style="font-size: 18px;" class="col-form-label">Картинка (Не обязательно)</p>

...
<div class="admin--container">
    ...
    @endif
    <form enctype="multipart/form-data" action="{{ route('reviews.store') }}" method="POST">
        @csrf
         <div class="login_card-group">
            ...
            <div class="login_card-row">
                ...
                <input class="input-text" type="url" name="link" class="form-control" placeholder="Ссылка">
            </div>

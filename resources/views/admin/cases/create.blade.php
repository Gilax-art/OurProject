        ...
        @csrf
         <div class="login_card-group">
            ...
            <div class="login_card-row">
                ...
                <input class="input-text" required type="url" name="link" class="form-control" placeholder="Ссылка">
            </div>

            <div class="login_card-row">
                <p style="font-size: 18px;" class="col-form-label">Описание (Не обязательно)</p>
                <input class="input-text" type="text" name="description" class="form-control" placeholder="Описание">
            </div>

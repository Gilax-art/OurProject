...
<div class="admin--container">
    ...
    @endif
    <form enctype="multipart/form-data" action="{{ route('cases.store') }}" method="POST">
        @csrf
         <div class="login_card-group">
            ...
            <div class="login_card-row">
                ...
                <input class="input-text" required type="url" name="link" class="form-control" placeholder="Ссылка на сайт">
            </div>
            ...
            <div class="login_card-row">
                ...
                <label class="input-file">
                    <input type="file" required type="file" name="img" accept="image/*" class="form-control">		
            ...
            <div class="login_card-row">
                ...
                <input class="input-text disabled" required type="text" name="url" class="form-control" placeholder="Ссылка на проект">
            </div>

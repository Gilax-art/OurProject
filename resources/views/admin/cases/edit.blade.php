    ...
    <div class="login_card-group-wrapper">
        <form enctype="multipart/form-data" action="{{ route('cases.update',$case->id) }}" method="POST">
            ...
            <div class="login_card-group">
                ...
                <div class="login_card-row">
                    <p style="font-size: 18px;" class="col-form-label">Ссылка</p>
                    <input class="input-text" required value="{{ $case->link }}" type="url" name="link" class="form-control" placeholder="Ссылка">
                </div>

                <div class="login_card-row">
                    <p style="font-size: 18px;" class="col-form-label">Описание (Не обязательно)</p>
                    <input class="input-text" value="@if(!empty($case->description)) {{ $case->description }} @endif" type="text" name="description" class="form-control" placeholder="Описание">
                </div>

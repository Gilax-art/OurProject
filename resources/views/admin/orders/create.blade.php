...
<div class="admin--container">
    ...
    <h2 style="margin-bottom: 20px;" class="admin--message">Добавить заказ</h2>
        ...
        @csrf
         <div class="login_card-group">
            ...
            <div class="login_card-row">
                ...
                <input class="input-text" required type="tel" name="phone" class="form-control" placeholder="Телефон">
            </div>
            ...
            <div class="login_card-row">
                ...
                <div class="login_card-row-radio">
                    <label class="input-radio--label">
                        <input checked type="radio" class="input-radio" value="Новый" name="status">
                    ...
                    <label class="input-radio--label">
                        <input type="radio" class="input-radio" value="Принят" name="status">
                        <div class="input-radio--label-content">
                            <div class="input-radio--label-indicator">
                                <div class="input-radio--label-indicator-fill"></div>
                            </div>
                    ...
                    <label class="input-radio--label">
                        <input type="radio" class="input-radio" value="Отклонён" name="status">
                        <div class="input-radio--label-content">
                            <div class="input-radio--label-indicator">
                                <div class="input-radio--label-indicator-fill"></div>
                            </div>

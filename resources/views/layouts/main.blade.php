        ...
        <section class="popup">
            ...
            <div class="popup-main">
                <div class="popup-content">
                    ...
                    <form enctype="multipart/form-data" action="" method="POST" class="popup-main-form">
                        <div class="popup-main-form_inputs">
                            ...
                            <textarea class="input-text input-textarea" name="description" placeholder="Напишите описание проекта или прикрепите ваше ТЗ ниже"></textarea>
